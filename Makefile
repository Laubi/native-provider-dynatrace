...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Dynatrace CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Dynatrace controllers
...
# This target prepares repo for your provider by replacing all "dynatrace"
